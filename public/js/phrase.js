...
function randomPhrase() {
    ...
    $.get("https://raw.githubusercontent.com/thamiavicente/word-typer/master/servidor/app/api/phrases.js", changePhrase) //puxa os dados da api no servidor e executa uma funcao
...
function updateMaxField(data) {
    ...
    $.get("https://raw.githubusercontent.com/thamiavicente/word-typer/master/servidor/app/api/phrases.js", function(data){ //puxa o conteudo da api
...
function searchPhrase() {
    ...
    $.get("https://raw.githubusercontent.com/thamiavicente/word-typer/master/servidor/app/api/phrases.js", data, changePhraseChosen) //puxa o conteudo da api envia um parametro e executa uma funcao
    .fail(function(){ //caso falhe...
        $("#error").show(); //mostra a mensagem de erro
        setTimeout(function(){
